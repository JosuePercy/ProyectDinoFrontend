...
//     try {
//       const urlApi =
//         process.env.API_URL || "http://localhost:3001/pages/Juguete";
...
export default function DetailsJuguetes() {
  const route = useRouter();
  const [juguete, setJuguete] = useState<IJuguete>();

  useEffect(() => {
    if (route.query.id) {
      loadJuguete(route.query.id);
    }
  }, [route.query]);
    ...
    <>
      <TaskLayout>
        <div>
          <div className="box">
            <div className="container">
              <div className="picture-box">
                <img
                  src={functions.pathImg(juguete?.image)}
                  alt=""
                  className="dino-1"
                />
              </div>
              <div className="grouped-text">
                <a href="/" className="dino-title">
                  {juguete?.name}
                </a>
                <h1> {juguete?.description}</h1>

                <span className="titleone">¡Queda 1 producto disponible!</span>
                <div className="text-separation">
                  <p className="parrafo">
                    Vendido por: <strong>Plaza Vea</strong>
                ...
                <div className="line-5">
                  ...
                  <div className="line-precio">
                    ...
                    <span>35</span>
                    <sup>.90</sup>
                    <div className="descont-offer">- 40%</div>
                  </div>
                </div>
          ...
          <section className="two-part">
            <div className="conteiner-grouptext">
              <div className="title-two">
                <h1>
                  <strong>Sobre el producto</strong>
                </h1>
